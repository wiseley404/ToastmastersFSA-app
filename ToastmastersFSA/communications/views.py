...
def create_notif(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            html = render_to_string('communications/create_notif.html', {
                'form': form
            }, request)
...
def edit_notif(request, notif_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            html = render_to_string('communications/edit_notif.html', {
                'form': form,
                'notif': notif
            }, request)
            return JsonResponse({'success': False, 'html': html})
...
@login_required
def show_notification_message(request, notif_id):
    notif = get_object_or_404(Notification, id=notif_id)
    return render(request, 'communications/show_notif_message.html', {'notif':notif})
...
def create_email_list(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            html = render_to_string('communications/create_email_list.html', {
                'form': form
            }, request)
            return JsonResponse({'success': False, 'html': html})
    else:
...
def edit_email_list(request, email_list_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            html = render_to_string('communications/edit_email_list.html', {
                'form': form,
...
def edit_email_scheduled(request, email_scheduled_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            html = render_to_string('communications/edit_email_scheduled.html', {
                'form': form,
...
def create_email_scheduled(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            html = render_to_string('communications/create_email_scheduled.html', {
                'form': form
            }, request)
            return JsonResponse({'success': False, 'html': html})
    else:
        form = EmailScheduledForm()
    return render(request, 'communications/create_email_scheduled.html', {'form': form})
...
def edit_system_email(request, system_email_id):
    ...
    if request.method == 'POST':
        ...
        if email_system.code == 'ABSENCE_WARNING':
            ...
            if form.is_valid() and absence_form.is_valid():
                form.save()
                absence_form.save()
                return JsonResponse({'success': True})
            else:
                html = render_to_string('communications/edit_system_email.html', {
                    'form': form,
