...
urlpatterns = [
    path('historique/', views.show_historique_speeches_list, name='speech_historique'),
    path('planning/', views.show_future_speeches_list, name='speech_planning'),
    ...
    path('<discours_id>/delete/confirmation/', views.confirm_role_deletion, name='confirm_role_deletion'),
    path('<discours_id>/delete/', views.delete_role, name='delete_role')
