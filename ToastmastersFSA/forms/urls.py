...
urlpatterns = [
    ...
    path('form/submission/success/', views.show_form_success_submission, name='form_submitted_success'),
    path('forms/', views.show_published_forms_list, name='forms_list'),
    path('forms/historique/', views.show_historique_forms_list, name='historique_forms'),
    ...
    path('form/<int:form_id>/close/', views.fermer_formulaire, name='close_form'),
]